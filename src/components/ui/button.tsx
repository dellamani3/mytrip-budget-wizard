...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary-light shadow-soft hover:shadow-travel",
        destructive:
        ...
        travel: "bg-gradient-sky text-white hover:shadow-glow transform hover:scale-105 transition-spring",
        sunset: "bg-gradient-sunset text-white hover:shadow-travel transform hover:scale-105 transition-spring",
        ocean: "bg-gradient-ocean text-white hover:shadow-soft",
        tropical: "bg-gradient-tropical text-white hover:shadow-glow",
      },
      size: {
